...
def test_convert_azfp_01a_matlab_raw(azfp_path):
    ...
    # backscatter count
    assert np.array_equal(
        np.array([ds_matlab_output["Output"][0]["N"][fidx] for fidx in range(4)]),
    ...
    assert np.array_equal(
        np.array([d[0] for d in ds_matlab["Data"]["BatteryMain"][0]]).squeeze(),
...
def test_convert_azfp_01a_matlab_derived():
    ...
    pytest.xfail(
        "Tests for converting AZFP and comparing it"
...
def test_convert_azfp_01a_raw_echoview(azfp_path):
    ...
    azfp_csv_path = [
        azfp_path / f"from_echoview/17082117-raw{freq}.csv" for freq in [38, 125, 200, 455]
    ]
    channels = []
...
def test_load_parse_azfp_xml(azfp_path):
    ...
    expected_params = [
        ...
        "backplane",
        "delay_transmission_string",
        "delay_transmission",
        "eclock",
        "digital_board_version",
        "sensors_flag_pressure_sensor_installed",
        "sensors_flag_paros_installed",
        "sensors_flag",
        "U0",
        "Y1",
        "Y2",
        ...
        "frequency",
        "phase_number",
        "start_date_svalue_phase1",
        "start_date_phase1",
        "phase_type_svalue_phase1",
        "phase_type_phase1",
        "duration_svalue_phase1",
        "duration_phase1",
        "ping_period_units_phase1",
        "ping_period_phase1",
        "burst_interval_units_phase1",
        "burst_interval_phase1",
        "pings_per_burst_units_phase1",
        "pings_per_burst_phase1",
        "average_burst_pings_units_phase1",
        "average_burst_pings_phase1",
        "frequency_number_phase1",
        "acquire_frequency_units_phase1",
        "acquire_frequency_phase1",
        "pulse_len_units_phase1",
        "pulse_len_phase1",
        "dig_rate_units_phase1",
        "dig_rate_phase1",
        "range_samples_units_phase1",
        "range_samples_phase1",
        "range_averaging_samples_units_phase1",
        "range_averaging_samples_phase1",
        "lock_out_index_units_phase1",
        "lock_out_index_phase1",
        "gain_units_phase1",
        "gain_phase1",
        "storage_format_units_phase1",
        "storage_format_phase1",
        "start_date_svalue_phase2",
        "start_date_phase2",
        "phase_type_svalue_phase2",
        "phase_type_phase2",
        "duration_svalue_phase2",
        "duration_phase2",
        "ping_period_units_phase2",
        "ping_period_phase2",
        "burst_interval_units_phase2",
        "burst_interval_phase2",
        "pings_per_burst_units_phase2",
        "pings_per_burst_phase2",
        "average_burst_pings_units_phase2",
        "average_burst_pings_phase2",
        "frequency_number_phase2",
        "acquire_frequency_units_phase2",
        "acquire_frequency_phase2",
        "pulse_len_units_phase2",
        "pulse_len_phase2",
        "dig_rate_units_phase2",
        "dig_rate_phase2",
        "range_samples_units_phase2",
        "range_samples_phase2",
        "range_averaging_samples_units_phase2",
        "range_averaging_samples_phase2",
        "lock_out_index_units_phase2",
        "lock_out_index_phase2",
        "gain_units_phase2",
        "gain_phase2",
        "storage_format_units_phase2",
        "storage_format_phase2",
        "rt_version",
        "rt_frequency",
        "enabled",
        "direction",
        "water_depth_high_tide",
